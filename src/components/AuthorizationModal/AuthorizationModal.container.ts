...
import { getData, getTransactions, getLoading } from '@beland/dapps/dist/modules/authorization/selectors'
import {
  grantTokenRequest,
  GRANT_TOKEN_REQUEST,
  revokeTokenRequest,
  REVOKE_TOKEN_REQUEST
} from '@beland/dapps/dist/modules/authorization/actions'
import { isPending } from '@beland/dapps/dist/modules/transaction/utils'
import { areEqual } from '@beland/dapps/dist/modules/authorization/utils'
