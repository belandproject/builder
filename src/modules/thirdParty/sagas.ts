...
export function* thirdPartySaga(_builder: BuilderAPI) {
  ...
  function* handleFetchThirdPartyAvailableSlots(_action: FetchThirdPartyAvailableSlotsRequestAction) {
  ...
  function* handlePublishThirdPartyItemRequest(_action: PublishThirdPartyItemsRequestAction) {
  ...
  // function* pushChangesToThirdPartyItems(_items: Item[]) {
    // const collectionId = getCollectionId(items)
 ...
 // }
  ...
  function* handlePushChangesThirdPartyItemRequest(_action: PushChangesThirdPartyItemsRequestAction) {
  ...
  function* handlePublishAndPushChangesThirdPartyItemRequest(_action: PublishAndPushChangesThirdPartyItemsRequestAction) {
