...
import { engine, GLTFShape, Transform, Entity, Component, NFTShape, IEntity, Vector3, AvatarShape, Wearable } from '@beland/ecs'
import * as ECS from '@beland/ecs'
import { createChannel } from '@beland/builder-scripts/channel'
import { createInventory } from '@beland/builder-scripts/inventory'
import { DecentralandInterface } from '@beland/ecs/dist/decentraland/Types'
...
const { Gizmos, SmartItem } = require('@beland/ecs') as any
